...
# save output
file_output = open('./results/kang_results_regression_CV_model_SEED_'+str(CV_model)+ '_Yelp_zip_code_'+str(ndim)+'_window_'+str(window)+'_min_count_'+str(min_count)+ model_type+'_search_'+search_type+'.csv', 'wt')
